...
:::tip 性能优化
1. **网卡 XPS/RPS 配置**：参考[基础操作](../../other-features/basic/basic/basic.md)文档，合理配置网卡的 XPS（Transmit Packet Steering）和 RPS（Receive Packet Steering），将网卡负载分散到不同 CPU 核心
...
- [分流控制](../flow/flow.md) - 了解如何配置流量转发规则
- [基础操作](../../other-features/basic/basic/basic.md) - 网卡 XPS/RPS 优化配置
- [防火墙设置](../../other-features/firewall/firewall.md) - 配合 eBPF 路由的安全策略
