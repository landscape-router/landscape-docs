        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Fails to Start on Alpine (bpffs Not Mounted)', link: '/faq/alpine-bpffs' },
            ],
          },
        ],
        editLink: {
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '开启 IPv6 重启路由后, 有些图片加载缓慢', link: '/zh/faq/reboot-slow' },
              { text: 'Alpine 下无法启动 (bpffs 未挂载)', link: '/zh/faq/alpine-bpffs' },
            ],
          },
        ],
        editLink: {
