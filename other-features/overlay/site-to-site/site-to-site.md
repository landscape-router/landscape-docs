...
启动后需要按照 [tailscale 组网](../tailscale/tailscale.md#启动容器) 中一样, 在 tailscale 的控制面板中允许此节点的路由.
...
以上配置之后, 除了在 [tailscale/配置-路由-规则](../tailscale/tailscale.md#配置-路由-规则) 中, 配置的 tailscale 的路由, 额外需要增加对方的 LAN 配置.  
