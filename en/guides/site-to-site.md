...
![](../../guides/site-to-site/topology.png)
...
Side B reaches not only tailscale IPs but also the far side's Docker containers, so add the container CIDR as well. ![](../../guides/site-to-site/b-zone-dstip.png)
...
![](../../guides/site-to-site/add-c-topology.png)
