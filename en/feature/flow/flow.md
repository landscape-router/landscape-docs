...
* `Default Flow`: Flow ***ID 0***, all `unmatched` traffic defaults to this flow, exit is the `default route` set in the topology, such as enabling the `Set as default route` switch in [PPPoE](../../../other-features/ipv4/ipv4/ipv4.md#pppoe)
...
![](../../../feature/flow/flow-10.png)  

This window will pop up
![](../../../feature/flow/flow-8.png)  
...
![Default flow](../../../feature/flow/flow-6.png)  
...
![Other flows](../../../feature/flow/flow-9.png) 
