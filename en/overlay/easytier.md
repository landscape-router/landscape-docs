...
Then create a Flow that uses this container as its egress. ![](../../overlay/easytier/1.png)
...
![](../../overlay/easytier/2.png)

Open the management page.

![](../../overlay/easytier/3.png)

Choose to create a network.

![](../../overlay/easytier/4.png)

Fill it in to match your setup.

## Setting up NAT1

First enable the `Route LAN` service on the `bridge` the container belongs to, as shown below. ![](../../overlay/easytier/5.png)

> Static NAT configuration (the internal target port is the container port, the IP is the container IP) ![](../../overlay/easytier/6.png)

> Open the matching port in the firewall ![](../../overlay/easytier/7.png)

## Configuring the "route" rules

Click the `Destination IP` button on the relevant Flow to configure it. Only Flows with a matching rule take effect. ![](../../overlay/easytier/8.png)
