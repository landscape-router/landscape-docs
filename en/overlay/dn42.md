...
Then create a Flow that uses this container as its egress. ![](../../overlay/dn42/1.png)
...
> Static NAT configuration (the internal target port is the container's wg port, the IP is the container IP) ![](../../overlay/dn42/3.png)

> Open the matching port in the firewall ![](../../overlay/dn42/4.png)

## Configuring the "route" rules

Click the `Destination IP` button on the relevant Flow to configure it. Only Flows with a matching rule take effect. ![](../../overlay/dn42/5.png)
